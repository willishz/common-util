...
public final class IpUtil  {
    ...
    private static final Log _log = LogFactory.getLog(IpUtil.class);
    ...
    static {
        try {
            // 配置文件路径,加载配置文件
           InputStream fis = IpUtil.class.getClassLoader().getResourceAsStream("ip_whitelist.properties");
...
//           _log.error(e.getMessage());
    ...
    public static String getRemoteIPAddress(HttpServletRequest request) {
        ...
        try {
            ...
            if (ipAddress == null || ipAddress.length() == 0 || IpUtil.UNKNOWN.equalsIgnoreCase(ipAddress)) {

...
public class JsonUtil {
    ...
    public static String beanToJson(Object obj, boolean serializeNullValue) {
        ...
        // Bean -> Json
        Gson gson = serializeNullValue ? new GsonBuilder().serializeNulls().disableHtmlEscaping().create() : new GsonBuilder().disableHtmlEscaping().create();
    ...
    public static String beanWithDateToJson(Object obj, boolean serializeNullValue) {
        ...
        Gson gson = serializeNullValue ? gsonBuilder.serializeNulls()
                ...
                : gsonBuilder.registerTypeAdapter(java.util.Date.class, new DateSerializerUtils()).setDateFormat(DateFormat.LONG).disableHtmlEscaping().create();
        String json = gson.toJson(obj);
        return json;
    }
...
//        gson = builder.create();
        ...
        try {
            ...
            logger.error(json.toString(), e);
            throw new IllegalStateException("超时失败请重试");
        }
    }

    public static <T> T jsonToBeanWithTime(String json, Class<T> clazz) {
        if (json == null || "".equals(json.trim())) {
            return null;
        }
        StringReader strReader = new StringReader(json);
    ...
    public static <T> T jsonWithDateToBean(String json, Class<T> clazz) {
        ...
        Gson gson = new GsonBuilder().registerTypeAdapter(java.util.Date.class, new DateDeserializerUtils())
                .setDateFormat(DateFormat.LONG).create();
    ...
    public static <T> String listToJson(List<T> list, boolean serializeNullValue) {
        ...
        // List -> Json
        Gson gson = serializeNullValue ? new GsonBuilder().serializeNulls().disableHtmlEscaping().create() : new Gson();
     ...
     * 
     */
    public static <T> String mapToJson(Map map, boolean serializeNullValue) {
        if (map == null) {
            return null;
        }
        Gson gson = serializeNullValue ? new GsonBuilder().serializeNulls().disableHtmlEscaping().create() : new GsonBuilder().disableHtmlEscaping().create();
